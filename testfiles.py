...
with st.sidebar:
    ...
    st.download_button(label="Validation Report" , data=" ", file_name="test.csv" )



st.file_uploader(label="Upload AML file" , key="AML_Upload1_Button")

st.download_button(label="Validation Report1" , data=" ", )


st.button(label="Click Me", key="button0")


st.button(label="Click Me", key="button1", type="primary")

st.button(label="Click Me", key="button2", type="primary", use_container_width= True)


st.button(label="Click Me", key="button3", type="secondary")
...
with case1:
    ...
    with column1:
        with st.expander("Expand me"):
            button1 = st.button(label="Click me", key="button4",
                                type="primary", use_container_width=True)

    with column2:
        st.button(label="Click me", key="button5", type="secondary")
...
if button1:
    st.success("Successfully clicked on button")
